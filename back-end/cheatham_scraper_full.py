"""
Cheatham County Production Scraper
===================================

Production scraper for Cheatham County (Ashland City area).
...
USAGE:
    python cheatham_scraper_full.py
"""
...
COUNTY = "Cheatham"  # Cheatham County
